...
const EXTRAS_GLOBALES = [
  { name: "Medallón de carne",   price: 2500 },
  { name: "Carne de lomo 100gr", price: 4000 },
  { name: "Cheddar",             price: 1000 },
  { name: "Panceta",             price: 1000 },
...
const DATA = {
  ...
  fries: [
    ...
    },
    {
      ...
      price: 9000,
      img: "img/papas-bacon-grande.jpeg",
      remove: ["Bacon"],
      extras: [
        { name: "Extra bacon",    price: 1000 },
        { name: "Dip de mayo",    price: 500  },
  ...
  bebidas: [
    ...
    },
    {
      id: "d3",
      name: "Pepsi 2,25lts",
      desc: "Botella grande de Pepsi, 2,25 litros.",
      price: 4000,
      img: "img/pepsi.jpg",
      remove: [],
      extras: [],
